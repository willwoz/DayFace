...
//            console.log('Location is are ' + curr_location);
          ...
          // Send tp Pebble
            var transactionId = Pebble.sendAppMessage({
              ...
              function(e) {
                console.log('Send successful! tand_id:'+e.data.transactionId);
              }, function(e) {
                console.log('Send failed! Error is: ' + JSON.stringify(e));
              }
            );
        }
    );      
...
//    var url = 'https://2f19a4e3.ngrok.io';
...
Pebble.addEventListener('webviewclosed', function(e) {
    ...
    if (configData.countfrom) {
        var transactionId = Pebble.sendAppMessage({
            ...
            digitalcolor: parseInt(configData.digitalcolor),
            wakeup: parseInt(configData.wakeup),
            bedtime: parseInt(configData.bedtime),
            saver: configData.saver,
        }, function(e) {
